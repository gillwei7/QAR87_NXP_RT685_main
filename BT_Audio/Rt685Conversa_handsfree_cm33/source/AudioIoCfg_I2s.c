...
dma_handle_t I2S1Tx0DmaHandle;
dma_handle_t I2S3Rx0DmaHandle;

i2s_dma_handle_t I2S1Tx0Handle;
i2s_dma_handle_t I2S3Rx0Handle;

__attribute__((__section__(".data.$Audio_IO_Data"))) __attribute__((aligned(4)))
volatile S32 I2S3Rx0BufCh2And3Mixed_A[AudioFrameSizeInSamplePerCh*2];    //1 frame samples --- for 2 channels mixed I2S audio data

__attribute__((__section__(".data.$Audio_IO_Data"))) __attribute__((aligned(4)))
volatile S32 I2S3Rx0BufCh2And3Mixed_B[AudioFrameSizeInSamplePerCh*2];    //1 frame samples --- for 2 channels mixed I2S audio data

__attribute__((__section__(".data.$Audio_IO_Data"))) __attribute__((aligned(4)))
volatile S32 I2S1Tx0BufCh0And1Mixed_A[AudioFrameSizeInSamplePerCh*2];    //1 frame samples --- for 2 channels mixed I2S audio data

__attribute__((__section__(".data.$Audio_IO_Data"))) __attribute__((aligned(4)))
volatile S32 I2S1Tx0BufCh0And1Mixed_B[AudioFrameSizeInSamplePerCh*2];    //1 frame samples --- for 2 channels mixed I2S audio data


__attribute__((__section__(".data.$Audio_IO_Data")))
__attribute__((aligned(16)))
SDK_ALIGN(static dma_descriptor_t I2S3Rx0DmaDescriptors[2U], FSL_FEATURE_DMA_LINK_DESCRIPTOR_ALIGN_SIZE);
__attribute__((__section__(".data.$Audio_IO_Data")))
__attribute__((aligned(16)))
SDK_ALIGN(static dma_descriptor_t I2S1Tx0DmaDescriptors[2U], FSL_FEATURE_DMA_LINK_DESCRIPTOR_ALIGN_SIZE);

__attribute__((__section__(".data.$Audio_IO_Data")))
__attribute__((aligned(16)))
static i2s_transfer_t I2S3Rx0Transfer[2]=
{
	{
        .data     = (unsigned char *)I2S3Rx0BufCh2And3Mixed_A,
        .dataSize = sizeof(I2S3Rx0BufCh2And3Mixed_A),
    },
    {
        .data     = (unsigned char *)I2S3Rx0BufCh2And3Mixed_B,
        .dataSize = sizeof(I2S3Rx0BufCh2And3Mixed_B),
    }
};
__attribute__((__section__(".data.$Audio_IO_Data")))
__attribute__((aligned(16)))
static i2s_transfer_t I2S1Tx0Transfer[2]=
{
	{
        .data     = (unsigned char *)I2S1Tx0BufCh0And1Mixed_A,
        .dataSize = sizeof(I2S1Tx0BufCh0And1Mixed_A),
    },
    {
        .data     = (unsigned char *)I2S1Tx0BufCh0And1Mixed_B,
        .dataSize = sizeof(I2S1Tx0BufCh0And1Mixed_B),
    }
};
...
void ClearDmaBuf_I2S3Rx0(void)
{
	memset((void *)I2S3Rx0BufCh2And3Mixed_A,0,sizeof(I2S3Rx0BufCh2And3Mixed_A));
	memset((void *)I2S3Rx0BufCh2And3Mixed_B,0,sizeof(I2S3Rx0BufCh2And3Mixed_B));
}
void ClearDmaBuf_I2S1Tx0(void)
{
	memset((void *)I2S1Tx0BufCh0And1Mixed_A,0,sizeof(I2S1Tx0BufCh0And1Mixed_A));
	memset((void *)I2S1Tx0BufCh0And1Mixed_B,0,sizeof(I2S1Tx0BufCh0And1Mixed_B));
}
...
void EnableI2S1Tx0DmaChannel(void)
{
	((DMA_Type *)(DEMO_DMA))->CHANNEL[I2S_FC1Tx_DMA_CHANNEL].XFERCFG |= DMA_CHANNEL_XFERCFG_SWTRIG_MASK;
}
void EnableI2S3Rx0DmaChannel(void)
{
	((DMA_Type *)(DEMO_DMA))->CHANNEL[I2S_FC3Rx_DMA_CHANNEL].XFERCFG |= DMA_CHANNEL_XFERCFG_SWTRIG_MASK;
}

__attribute__((section("CodeQuickAccess")))
void ImmediatelyStartI2S3Dma(void)
{
	((I2S_Type *)DEMO_I2S3Rx0)->FIFOCFG |= I2S_FIFOCFG_DMARX_MASK;
...
{
	((I2S_Type *)DEMO_I2S1Tx0)->FIFOCFG |= I2S_FIFOCFG_DMATX_MASK;
	NVIC_SetPriority(DMA0_IRQn, (USB_DEVICE_INTERRUPT_PRIORITY + 1U));
	EnableIRQ(DMA0_IRQn);
}
#endif
...
{
	DMA_EnableChannel(DEMO_DMA, I2S_FC3Rx_DMA_CHANNEL);
	DMA_SetChannelPriority(DEMO_DMA, I2S_FC3Rx_DMA_CHANNEL, kDMA_ChannelPriority4);
	DmaDscrPtr_I2S3 =Ptr_dma_descriptor_table0+4*I2S_FC3Rx_DMA_CHANNEL;
}
void BOARD_Init_DMA_I2S_Fc1(void)
{
	DMA_EnableChannel(DEMO_DMA, I2S_FC1Tx_DMA_CHANNEL);
	DMA_SetChannelPriority(DEMO_DMA, I2S_FC1Tx_DMA_CHANNEL, kDMA_ChannelPriority5);
	DmaDscrPtr_I2S1 =Ptr_dma_descriptor_table0+4*I2S_FC1Tx_DMA_CHANNEL;
}
void BOARD_Init_I2S_Fc1(void)
{
	...
	I2S_Tx_config.masterSlave = DEMO_I2S1Tx0_MODE;
	I2S_TxInit(DEMO_I2S1Tx0, &I2S_Tx_config);
}
void BOARD_Init_I2S_Fc3(void)
{
	...
	I2S_Rx_config.masterSlave = DEMO_I2S3Rx0_MODE;
	I2S_RxInit(DEMO_I2S3Rx0, &I2S_Rx_config);
}
#endif
#if 1	//folding --- callback
int GetI2S3DmaTransferringIsUsingBufAOrB(void)
{
	return (*(DmaDscrPtr_I2S3+3) ==(unsigned int)&I2S3Rx0DmaDescriptors[1]);
}
int GetI2S1DmaTransferringIsUsingBufAOrB(void)
{
	return (*(DmaDscrPtr_I2S1+3) ==(unsigned int)&I2S1Tx0DmaDescriptors[1]);
}
void WaitForRx0LRCKRisingEdge_Fc3(void)
{
	...
	{
		if(
				((((I2S_Type *)DEMO_I2S3Rx0)->STAT) & 0x4) ==0x0	//now it is left channel
		  )
			break;
	}
	//now it is left
	...
	{
		if(
				((((I2S_Type *)DEMO_I2S3Rx0)->STAT) & 0x4) ==0x4	//now it is right channel
		  )
			break;
	}
	//now it is just coming into right
}
void WaitForRx0LRCKFallingEdge_Fc3(void)
{
	//this part is to make sure I2S tx rx starts immediately after the LR edge
	//wait till it is I2S left  (LRCK falling edge)
	//now it is left
...
void WaitForTx0LRCKRisingEdge_Fc1(void)
{
	//this part is to make sure I2S tx rx starts immediately after the LR edge
	//wait till it is I2S left  (LRCK falling edge)
	//now it is right
	...
	{
		if(
				((((I2S_Type *)DEMO_I2S1Tx0)->STAT) & 0x4) ==0x0	//now it is left channel
		  )
			break;
	}
	//now it is left
	...
	{
		if(
				((((I2S_Type *)DEMO_I2S1Tx0)->STAT) & 0x4) ==0x4	//now it is right channel
		  )
			break;
	}
	//now it is just coming into right
}
void WaitForTx0LRCKFallingEdge_Fc1(void)
{
	//this part is to make sure I2S tx rx starts immediately after the LR edge
	//wait till it is I2S left  (LRCK falling edge)
	//now it is left
...
void CloseI2sDma(I2S_Type *I2SBase)
{
	switch((U32)I2SBase)
	{
		case (U32)DEMO_I2S3Rx0:
				I2S_TransferAbortDMA(DEMO_I2S3Rx0, &I2S3Rx0Handle);
				DMA_DisableChannel(DEMO_DMA, I2S_FC3Rx_DMA_CHANNEL);
			break;
		case (U32)DEMO_I2S1Tx0:
				I2S_TransferAbortDMA(DEMO_I2S1Tx0, &I2S1Tx0Handle);
				DMA_DisableChannel(DEMO_DMA, I2S_FC1Tx_DMA_CHANNEL);
			break;
		default:
			break;
	}
...
__attribute__((section("CodeQuickAccess")))
void I2S1Tx0_Callback(I2S_Type *base, i2s_dma_handle_t *handle, status_t completionStatus, void *userData)
{
	DbgPin7Up();
...
__attribute__((section("CodeQuickAccess")))
void I2S3Rx0_Callback(I2S_Type *base, i2s_dma_handle_t *handle, status_t completionStatus, void *userData)
{
	DbgPin7Up();
	if(CheckTimePoint_CurrentIntrIsAStartingOne())
	{
...
{
	DMA_CreateHandle(&I2S1Tx0DmaHandle, DEMO_DMA, I2S_FC1Tx_DMA_CHANNEL);
	I2S_TxTransferCreateHandleDMA(DEMO_I2S1Tx0,  &I2S1Tx0Handle, &I2S1Tx0DmaHandle, I2S1Tx0_Callback,I2S1Tx0Transfer);
	I2S_TransferInstallLoopDMADescriptorMemory   (&I2S1Tx0Handle,  I2S1Tx0DmaDescriptors, 2U);
    if (I2S_TransferSendLoopDMA   (DEMO_I2S1Tx0, &I2S1Tx0Handle, &I2S1Tx0Transfer[0], 2U) != kStatus_Success)
    {
        assert(false);
    }
	StartI2SAudioDmaFromDmicDmaIntr_Cnt=0;
...
{
	DMA_CreateHandle(&I2S3Rx0DmaHandle, DEMO_DMA, I2S_FC3Rx_DMA_CHANNEL);
	I2S_RxTransferCreateHandleDMA(DEMO_I2S3Rx0,  &I2S3Rx0Handle, &I2S3Rx0DmaHandle, I2S3Rx0_Callback,I2S3Rx0Transfer);
    I2S_TransferInstallLoopDMADescriptorMemory   (&I2S3Rx0Handle,  I2S3Rx0DmaDescriptors, 2U);
    if (I2S_TransferReceiveLoopDMA(DEMO_I2S3Rx0, &I2S3Rx0Handle, &I2S3Rx0Transfer[0], 2U) != kStatus_Success)
    {
        assert(false);
    }
	StartI2SAudioDmaFromDmicDmaIntr_Cnt=0;
