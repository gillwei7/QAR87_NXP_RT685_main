...
#define BOARD_INITFLEXSPIFLASHPINS_QSPI_B_CS0_PORT 2U	/*!* @brief PORT peripheral base pointer */
#define BOARD_INITFLEXSPIFLASHPINS_QSPI_B_CS0_PIN 19U	/*!* @brief PORT pin number */
#define BOARD_INITFLEXSPIFLASHPINS_QSPI_B_CS0_PIN_MASK (1U << 19U)	/*!* @brief PORT pin mask */
/* @} */
