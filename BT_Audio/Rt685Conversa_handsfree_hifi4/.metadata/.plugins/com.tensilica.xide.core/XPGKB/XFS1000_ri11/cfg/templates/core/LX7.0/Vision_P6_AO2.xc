...
<system_file>
    <xtensa_configuration>
        <config_name buildTS="0" isaSavTS="1638850368844" parent_bid="0" parent_tdb_cksm="0" tieSavTS="0" variant="0">XRC_Vision_P6_AO2</config_name>
        <config_isa description="">
            <core formatversion="7000" isaversion="LX7.0" locked="0" name="XRC_Vision_P6_AO2">
                <coreisa>
                ...
                <targets>
                    ...
                    <cfg cfg_auto_mmap="0" cfg_auto_vectors="0" cfg_last_written_ver="918" cfg_mmu_lmems_space="0xFE000000" cfg_vector_style="lx5_sysram" editor_rel="none" fusa_iso26262="0" template_op="none"/>
                </targets>
            </core>
        </config_isa>
