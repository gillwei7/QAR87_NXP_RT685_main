...
<config_name buildTS="0" isaSavTS="1622107176640" parent_bid="0" parent_tdb_cksm="0" tieSavTS="0" variant="0">sample_full_mmu_lmem</config_name>
<config_isa description="">
<core formatversion="7000" isaversion="LX7.0" locked="0" name="sample_full_mmu_lmem">
<coreisa>
...
<lmem>
<lmem.0 busy="0" dma="0" memErr="0" paddr="0x01040000" secsize="0x0" size="0x20000" type="instram.0"/>
<lmem.1 busy="0" dma="0" memErr="0" nbanks="1" paddr="0x01000000" secsize="0x0" size="0x20000" type="dataram.0"/>
<lmem.2 busy="0" dma="0" memErr="0" nbanks="1" paddr="0x01020000" secsize="0x0" size="0x20000" type="dataram.1"/>
</lmem>
<smem>
...
<messages>
<msg.1 msg.1.origin="Xplorer" msg.1.sev="2" msg.1.txt="The selected value of &amp;lt;Memory management selection&amp;gt; (Full MMU with TLBs) recommends that &amp;lt;Count of timers&amp;gt; is at least 2"/>
...
<msg.3 msg.3.origin="Xplorer" msg.3.sev="2" msg.3.txt="The selected value of &amp;lt;Memory management selection&amp;gt; (Full MMU with TLBs) recommends that &amp;lt;Conditional Store Sync&amp;gt; is selected"/>
<msg.4 msg.4.origin="Xplorer" msg.4.sev="2" msg.4.txt="The selected value of &amp;lt;Memory management selection&amp;gt; (Full MMU with TLBs) recommends that &amp;lt;Misc Special registers&amp;gt; is at least 2"/>
<msg.5 msg.5.origin="Xplorer" msg.5.sev="2" msg.5.txt="if the instruction cache way size (cache size / number of ways) &amp;gt; 4 kB, ensure any OS making use of the MMU page translation features supports page coloring"/>
