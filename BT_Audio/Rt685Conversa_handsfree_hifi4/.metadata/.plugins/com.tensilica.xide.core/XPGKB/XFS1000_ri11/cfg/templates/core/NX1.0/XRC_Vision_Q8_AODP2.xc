...
<system_file>
    <xtensa_configuration>
        <config_name buildTS="0" isaSavTS="1638504514254" parent_bid="0" parent_tdb_cksm="0" tieSavTS="0" variant="0">XRC_Vision_Q8_AODP2</config_name>
        <config_isa description="">
            <core formatversion="8000" isaversion="NX1.0" locked="0" name="XRC_Vision_Q8_AODP2">
                <coreisa>
                    ...
                    <idma idma="1" idma_addr_width="32" idma_axi_channels="0" idma_buf_depth="4" idma_channels="2" idma_data_width="256" idma_max_descriptor="64" idma_max_reqs="64" idma_reorder_buf="0"/>
                ...
                <targets>
                    ...
                    <cfg cfg_last_written_ver="918" editor_rel="none" fusa_iso26262="0" template_op=""/>
                </targets>
