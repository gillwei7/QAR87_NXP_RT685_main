...
extern S16 MicS16TmpBuf[AudioFrameSizeInSamplePerCh];

extern S32 MicS32Buf[8][AudioFrameSizeInSamplePerCh];
extern S32 MicS32Buf16KHz[6][AudioFrameSizeInSamplePerCh/3];

extern S32 RawMic32BitBuf1 [AudioFrameSizeInSamplePerCh];
extern S32 RawMic32BitBuf2 [AudioFrameSizeInSamplePerCh];



extern void InitConversa(void);

extern void AudioProcessOnEachFrame(void);

extern void Init_AudioProcessOnEachFrame(void);
