...
VoiceCommandMenu_t CurMenu;
VoiceCommandMenu_t PreMenu;
...
void IdentifyCurrentVoiceCommand(void)
{
	...
	{
		CurrentVoiceCommandIntent=ASR_Menu_AiConversation;
		if(!strcmp("Home",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_GoHomeAiconversation;
			PRINTF("ASR_VoiceCommand_GoHomeAiconversation\r\n");
		}
	}
	if(!strcmp("Call",CurrentIntentName))
	{
		CurrentVoiceCommandIntent=ASR_Menu_PhoneCall;
		if(!strcmp("answer",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_AnswerThePhone;
			PRINTF("ASR_VoiceCommand_AnswerThePhone\r\n");
		}
		if(!strcmp("reject",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_RejectThePhone;
			PRINTF("ASR_VoiceCommand_RejectThePhone\r\n");
		}
		if(!strcmp("hang_up",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_HangUpThePhone;
			PRINTF("ASR_VoiceCommand_HangUpThePhone\r\n");
		}
	}
	if(!strcmp("Home",CurrentIntentName))
	{
		CurrentVoiceCommandIntent=ASR_Menu_Home;
		if(!strcmp("Translation",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_StartTranslation;
			PRINTF("ASR_VoiceCommand_StartTranslation\r\n");
		}
		if(!strcmp("VideoAI",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_StartVideoAi;
			PRINTF("ASR_VoiceCommand_StartVideoAi\r\n");
		}
		if(!strcmp("AIConversation",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_StartAiConversation;
			PRINTF("ASR_VoiceCommand_StartAiConversation\r\n");
		}
		if(!strcmp("MediaPlayer",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_GoMediaPlayer;
			PRINTF("ASR_VoiceCommand_GoMediaPlayer\r\n");
		}
		if(!strcmp("Photo",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_TakePhoto;
			PRINTF("ASR_VoiceCommand_TakePhotoOrPicture\r\n");
		}
		if(!strcmp("VideoRecording",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_StartRecording;
			PRINTF("ASR_VoiceCommand_StartRecording\r\n");
		}
	}
	if(!strcmp("MediaPlayer",CurrentIntentName))
	{
		CurrentVoiceCommandIntent=ASR_Menu_MediaPlayer;
		if(!strcmp("play",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_Play;
			PRINTF("ASR_VoiceCommand_Play\r\n");
		}
		if(!strcmp("pause",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_Pause;
			PRINTF("ASR_VoiceCommand_Pause\r\n");
		}
		if(!strcmp("previous",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_Previous;
			PRINTF("ASR_VoiceCommand_Previous\r\n");
		}
		if(!strcmp("next",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_Next;
			PRINTF("ASR_VoiceCommand_Next\r\n");
		}
		if(!strcmp("up",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_VolumeUpMediaplayer;
			PRINTF("ASR_VoiceCommand_VolumeUpMediaplayer\r\n");
		}
		if(!strcmp("down",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_VolumeDownMediaplayer;
			PRINTF("ASR_VoiceCommand_VolumeDownMediaplayer\r\n");
		}
		if(!strcmp("Home",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_GoHomeMediaplayer;
			PRINTF("ASR_VoiceCommand_GoHomeMediaplayer\r\n");
		}
	}
	if(!strcmp("MusicPlayer",CurrentIntentName))
	{
		CurrentVoiceCommandIntent=ASR_Menu_MusicPlayer;
		if(!strcmp("play",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_PlayMusic;
			PRINTF("ASR_VoiceCommand_PlayMusic\r\n");
		}
		if(!strcmp("pause",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_PauseMusic;
			PRINTF("ASR_VoiceCommand_PauseMusic\r\n");
		}
		if(!strcmp("previous",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_PreviousSong;
			PRINTF("ASR_VoiceCommand_PreviousSong\r\n");
		}
		if(!strcmp("next",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_NextSong;
			PRINTF("ASR_VoiceCommand_NextSong\r\n");
		}
		if(!strcmp("up",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_VolumeUpMusicplayer;
			PRINTF("ASR_VoiceCommand_VolumeUpMusicplayer\r\n");
		}
		if(!strcmp("down",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_VolumeDownMusicplayer;
			PRINTF("ASR_VoiceCommand_VolumeDownMusicplayer\r\n");
		}
		if(!strcmp("Home",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_GoHomeMusicplayer;
			PRINTF("ASR_VoiceCommand_GoHomeMusicplayer\r\n");
		}
	}
	if(!strcmp("Photo",CurrentIntentName))
	{
		CurrentVoiceCommandIntent=ASR_Menu_TakePhoto;
		if(!strcmp("Home",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_GoHomePhoto;
			PRINTF("ASR_VoiceCommand_GoHomePhoto\r\n");
		}
	}
	if(!strcmp("Translation",CurrentIntentName))
	{
		CurrentVoiceCommandIntent=ASR_Menu_Translation;
		if(!strcmp("Home",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_GoHomeTranslation;
			PRINTF("ASR_VoiceCommand_GoHomeTranslation\r\n");
		}
	}
	if(!strcmp("VideoAI",CurrentIntentName))
	{
		CurrentVoiceCommandIntent=ASR_Menu_VidioAi;
		if(!strcmp("Home",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_GoHomeVideoAi;
			PRINTF("ASR_VoiceCommand_GoHomeVideoAi\r\n");
		}
	}
	if(!strcmp("VideoRecording",CurrentIntentName))
	{
		CurrentVoiceCommandIntent=ASR_Menu_VideoRecording;
		if(!strcmp("Home",CurrentTagName))
		{
			CurrentVoiceCommandTagName=ASR_VoiceCommand_GoHomeVideoRecording;
			PRINTF("ASR_VoiceCommand_GoHomeVideoRecording\r\n");
		}
	}

	#if defined(MASK_SIE)
		if(CurrentVoiceCommandIntent!=CurMenu)
...
void InitVit(void)
{
	...
	CurMenu=ASR_Menu_Home;
	PreMenu=ASR_Menu_Home;
	initCreateVIT(&vitPluginParams);
}
					   ...
					   PL_UINT16* 	 			 p_vitVcDetectionId)
{
            ...
            || (VIT_DetectionResults == VIT_INTENT_DETECTED))
    {
        if (VIT_DetectionResults == VIT_WW_DETECTED)
        {
            ...
            else if (s_WakeWord.Id > 0)
            {
                ...
                PRINTF("[ASR] Wake Word: %s(%d) --- In %s menu\r\n", (s_WakeWord.pName == PL_NULL) ? "UNDEF" : s_WakeWord.pName, s_WakeWord.Id, MenuItemName[CurMenu]);
	...
	else if (VIT_DetectionResults == VIT_VC_DETECTED)
	{
		...
		if(CurrentTagValue1!=NULL)
		{
			switch(CurrentVoiceCommandIntent)
			{
				case ASR_Menu_Home:
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_TakePhoto)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_TakePhoto;
						...
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_StartRecording)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_VideoRecording;
						...
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_StartTranslation)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_Translation;
						...
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_StartVideoAi)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_VidioAi;
						...
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_StartAiConversation)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_AiConversation;
						...
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_GoMediaPlayer)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_MediaPlayer;
				...
				case ASR_Menu_VidioAi:
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_GoHomeVideoAi)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_Home;
							VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
				...
				case ASR_Menu_AiConversation:
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_GoHomeAiconversation)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_Home;
							VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
				...
				case ASR_Menu_Translation:
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_GoHomeTranslation)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_Home;
							VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
					...
					break;
				case ASR_Menu_TakePhoto:
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_GoHomePhoto)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_Home;
							VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
				...
				case ASR_Menu_VideoRecording:
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_GoHomeVideoRecording)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_Home;
							VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
				...
				case ASR_Menu_MediaPlayer:
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_GoHomeMediaplayer)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_Home;
							VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
				...
				case ASR_Menu_PhoneCall:
					if(CurrentVoiceCommandTagName==ASR_VoiceCommand_RejectThePhone)
					{
						PreMenu=CurMenu;
						CurMenu=ASR_Menu_Home;
						VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
					...
					if(CurrentVoiceCommandTagName==ASR_VoiceCommand_HangUpThePhone)
					{
						PreMenu=CurMenu;
						CurMenu=ASR_Menu_Home;
						VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
				...
				case ASR_Menu_MusicPlayer:
						if(CurrentVoiceCommandTagName==ASR_VoiceCommand_GoHomeMusicplayer)
						{
							PreMenu=CurMenu;
							CurMenu=ASR_Menu_Home;
							VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
		...
		if(PtrVarBlockSharedByDspAndMcu->U32ControlPara[0])
		{
			...
			if(CurMenu==ASR_Menu_Home)
			{
				PreMenu=CurMenu;
				CurMenu=ASR_Menu_MusicPlayer;
			...
			if(CurMenu==ASR_Menu_MusicPlayer)
			{
				PreMenu=CurMenu;
				CurMenu=ASR_Menu_Home;
				VIT_Status = VIT_ConfigureIntentSlotMask (*p_VITHandle, VIT_Intent_Slot_Mask_Home, sizeof(VIT_Intent_Slot_Mask_Home)/sizeof(PL_BOOL));
