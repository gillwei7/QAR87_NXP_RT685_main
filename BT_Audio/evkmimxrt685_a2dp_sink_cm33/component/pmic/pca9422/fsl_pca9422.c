...
#define FSL_DEBUG_PMIC_DRIVER 1

#if (defined(PCA9422_DEVIC_ID_PCA9422A) && PCA9422_DEVIC_ID_PCA9422A)
...
void PCA9422_InitCharger(pca9422_handle_t *handle, const pca9422_charger_config_t *config)
{
    ...
    chgCntl[1] = (uint8_t)(PCA9422_CHARGER_CNTL_1_AUTOSTOP_CHG_EN | PCA9422_CHARGER_CNTL_1_CHARGER_EN |
                           config->warmPlusVolt | config->prechgI | config->chgIStep);
    ...
    chgCntl[7] = (uint8_t)(PCA9422_CHARGER_CNTL_7_CHG_DISABLE_AT_COLD_HOT_EN | config->fastchgTime | config->coldIVbat |
                           config->warmVbatReg);
    ...
    chgCntl[10] = (uint8_t)((uint8_t)config->amuxWaitTime | config->amuxMode | (uint8_t)config->amuxVbatGain |
                            (uint8_t)config->amuxThermGain | config->amuxChannel);
    ...
    chgInCntl[1] = (uint8_t)(config->aiclV | PCa9422_CHGIN_CNTL_1_AICL_EN);
...
uint8_t PCA9422_GetPreChargeCurrent(pca9422_handle_t *handle)
{
    ...
    /* Write CHARGER_LOCK bit */
    regVal = PCA9422_CHARGER_LOCK_UNLOCK;
    PCA9422_WriteRegs(handle, PCA9422_CHG_CNTL0, &regVal, 1U);

    /* Read CHG_CNTL_1 */
    PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL1, &regVal, 1U);
...
uint8_t PCA9422_GetTopoffCurrent(pca9422_handle_t *handle)
{
    ...
    /* Read CHG_CNTL_4 */
    PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL4, &regVal, 1U);
...
bool PCA9422_SetFastChargeCurrent(pca9422_handle_t *handle, uint16_t iFast)
{
    ...
    if (iFast > 320U * 10U)
    {
        ...
        regVal = kPCA9422_ChgIStep5p0mA;
    }
    else
    {
        /* Set current step to 2.5mA */
        regVal = kPCA9422_ChgIStep2p5mA;
    }
    result = PCA9422_ModifyReg(handle, PCA9422_CHG_CNTL1, PCA9422_CHARGER_CNTL_1_CHG_CURRENT_STEP, regVal);
    if (result == false)
        goto error;
    /* Get current step */
    currStep = (regVal == kPCA9422_ChgIStep5p0mA) ? 50U : 25U;
    regVal   = (iFast - currStep) / currStep;
...
uint16_t PCA9422_GetFastChargeCurrent(pca9422_handle_t *handle)
{
    ...
    /* Read CHG_CNTL_1 */
    PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL1, &regVal, 1U);
    currStep = (regVal & PCA9422_CHARGER_CNTL_1_CHG_CURRENT_STEP) ? 50U : 25U;

    /* Read CHG_CNTL_3 */
    PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL3, &regVal, 1U);
    iFastReg = regVal * currStep + currStep;
...
uint16_t PCA9422_GetChargeCurrent(pca9422_handle_t *handle)
{
    ...
    PCA9422_ReadRegs(handle, PCA9422_CHARGER_0_STS, chgSts, 4U);
    ...
    /* Check CHARGER_0_STS */
    if (chgSts[0] & PCA9422_INT_CHARGER_0_CHG_QUAL_OK)
    {
        /* Qualification process for charging passed */
        /* Charging */
        if (chgSts[0] & PCA9422_INT_CHARGER_0_FAST_CHARGE)
        {
            /* Keep iCharge */
        }
        else if (chgSts[0] & PCA9422_INT_CHARGER_0_CV_MODE)
        {
            /* Keep iCharge */
        }
        else if (chgSts[0] & PCA9422_INT_CHARGER_0_TOPOFF)
        {
            /* Read topoff current */
            /* Read CHG_CNTL_4 */
            PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL4, &regVal, 1U);
            ...
            tempVal = (float)(iCharge * topOffCurr[regBit]) / 10 / 100;
            iCharge = (uint16_t)tempVal;
        }
        else if (chgSts[0] & PCA9422_INT_CHARGER_0_PRECHARGE)
        {
            ...
            tempVal = (float)(iCharge * preChgCurr[regBit]) / 100;
            iCharge = (uint16_t)tempVal;
        }
        else
        {
    ...
    /* Read CHG_CNTL_5 */
    PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL5, &regVal, 1U);
    /* Check THERM_NTC_EN bit */
    if ((regVal & PCA9422_CHARGER_CNTL_5_THERM_NTC_EN) && (iCharge != 0U))
    {
        /* Use JEITA function */
        /* Check JEITA interrupt happens */
        if (chgSts[1] & PCA9422_INT_CHARGER_1_THERM_HOT)
        {
            iCharge = 0U;
        }
        else if (chgSts[1] & PCA9422_INT_CHARGER_1_THERM_WARM_PLUS)
        {
            /* NEW_I_VBAT_AT_50C */
            /* Read CHG_CNTL_9 */
            PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL9, &regVal, 1U);
            regBit = (regVal & PCA9422_CHARGER_CNTL_9_NEW_I_VBAT_AT_50C) >>
                     MASK2SHIFT(PCA9422_CHARGER_CNTL_9_NEW_I_VBAT_AT_50C);
            tempVal = (float)(iCharge * thermCurr[regBit]) / 100;
            iCharge = (uint16_t)tempVal;
        }
        else if (chgSts[1] & PCA9422_INT_CHARGER_1_THERM_WARM)
        {
            /* NEW_I_VBAT_AT_45C */
            /* Read CHG_CNTL_9 */
            PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL9, &regVal, 1U);
        ...
        else if (chgSts[1] & PCA9422_INT_CHARGER_1_THERM_COOL)
        {
            /* NEW_I_VBAT_AT_10C */
            /* Read CHG_CNTL_7 */
            PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL7, &regVal, 1U);
            regBit = (regVal & PCA9422_CHARGER_CNTL_7_NEW_I_VBAT_AT_10C) >>
                     MASK2SHIFT(PCA9422_CHARGER_CNTL_7_NEW_I_VBAT_AT_10C);
            tempVal = (float)(iCharge * thermCurr[regBit]) / 100;
            iCharge = (uint16_t)tempVal;
        }
        else if (chgSts[1] & PCA9422_INT_CHARGER_1_THERM_COLD)
        {
            iCharge = 0U;
        }
        else if (chgSts[1] & PCA9422_INT_CHARGER_1_VBAT_OVP)
        {
            iCharge = 0U;
        }
        else if (chgSts[1] & PCA9422_INT_CHARGER_1_NO_BATTERY)
        {
            iCharge = 0U;
        }
        else
...
uint16_t PCA9422_GetVBATRegulation(pca9422_handle_t *handle)
{
    ...
    vFloat = regVal * PCA9422_VBAT_REG_STEP + PCA9422_VBAT_REG_MIN;
    ...
    PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL5, &regVal, 1U);
    /* Check THERM_NTC_EN bit */
    if (regVal & PCA9422_CHARGER_CNTL_5_THERM_NTC_EN)
    {
        /* Use JEITA function */
        /* Check JEITA interrupt happens */
        if (chgSts[1] & PCA9422_INT_CHARGER_1_THERM_WARM_PLUS)
        {
            /* NEW_VBAT_AT_50C */
            /* Read CHG_CNTL_9 */
            PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL9, &regVal, 1U);
...
bool PCA9422_SetVBATRegulation(pca9422_handle_t *handle, uint16_t vFloat)
{
    ...
    regVal = PCA9422_VBAT_REG(vFloat);
...
uint8_t PCA9422_GetChargeState(pca9422_handle_t *handle)
{
    ...
    /* Read CHARGER_0_STS ~ CHARGER_3_STS */
    PCA9422_ReadRegs(handle, PCA9422_CHARGER_0_STS, regVal, 4U);

    /* Check CHARGER_0_STS */
    if (regVal[0] & PCA9422_INT_CHARGER_0_CHG_QUAL_OK)
    {
        /* Qualification process for charging passed */
        /* Charging */
        if ((regVal[0] & PCA9422_INT_CHARGER_0_CV_MODE) || (regVal[0] & PCA9422_INT_CHARGER_0_TOPOFF))
            chgSts = 0x03U; /* CV mode - CV or TOPOFF */
        else if ((regVal[0] & PCA9422_INT_CHARGER_0_FAST_CHARGE) || (regVal[0] & PCA9422_INT_CHARGER_0_PRECHARGE))
            chgSts = 0x01U; /* CC mode - FAST CHARGE or PRE-CHARGE */
        else
            chgSts = 0x00U; /* Not charging */

        /* Check CHARGER_2_STS */
        if (regVal[2] & PCA9422_INT_CHARGER_2_CHARGE_DONE)
            chgSts = 0x04U;
    }
    else
    {
...
void PCA9422_SetAMUXMode(pca9422_handle_t *handle, pca9422_amux_mode_t mode)
{
    ...
    (void)PCA9422_ModifyReg(handle, PCA9422_CHG_CNTL10, PCA9422_CHARGER_CNTL_10_AMUX_MODE, (uint8_t)mode);
...
pca9422_amux_mode_t PCA9422_GetAMUXMode(pca9422_handle_t *handle)
{
    ...
    return (pca9422_amux_mode_t)(regVal & PCA9422_CHARGER_CNTL_10_AMUX_MODE);
}
...
float PCA9422_GetAMUXScaleFactor(pca9422_handle_t *handle, pca9422_amux_channel_t channel)
{
    ...
    switch (channel)
    {
        ...
        case kPCA9422_AMUXChannel_Vsys:
            /* Get scale factor */
            PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL10, &regVal, 1U);
            scaleFactor = (regVal & PCA9422_CHARGER_CNTL_10_AMUX_VBAT_VSYS_GAIN) ? 4 : 3;
            break;
        case kPCA9422_AMUXChannel_Therm:
        case kPCA9422_AMUXChannel_ThermBias:
            /* Get scale factor */
            PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL10, &regVal, 1U);
            scaleFactor = (regVal & PCA9422_CHARGER_CNTL_10_AMUX_THERM_GAIN) ? 1.5 : 1;
            break;
...
bool PCA9422_SetEnableCharge(pca9422_handle_t *handle, bool enable)
{
    ...
    if (enable == true)
    {
        ...
        PCA9422_ReadRegs(handle, PCA9422_CHG_CNTL9, &regVal, 1U);
        if (regVal & PCA9422_CHARGER_CNTL_9_USB_SUSPEND)
        {
...
void PCA9422_GetDefaultBuckConfig(pca9422_buck_config_t *buckCfg)
{
    ...
    buckCfg[0].dvsCtrl      = kPCA9422_DVS0thrI2CInActiveAndSleep;
    ...
    buckCfg[1].dvsCtrl      = kPCA9422_DVS0thrI2CInActiveAndSleep;
...
#else
    buckCfg[1].maxVout      = 3400000U;//1400000U; /* 1.4V */
#endif
...
#else
    buckCfg[2].dvsVout[0]   = 1800000U;//1000000U; /* 1.0V */
#endif
...
#else
    buckCfg[2].maxVout      = 1800000U; /* 1.2V */
#endif
...
#else
    bbCfg->vout      = 5000000U;//1800000U; /* 1.8V */
#endif
...
void PCA9422_InitRegulator(pca9422_handle_t *handle, const pca9422_regulator_config_t *config)
{
    ...
    /* INT1_MASK */
    regVal = 0xFFU;
    result = PCA9422_WriteRegs(handle, PCA9422_INT1_MASK, &regVal, 1U);
    if (result == false)
    {
    ...
    /* RESET_CTRL */
    regVal = 0x00U;
    result = PCA9422_WriteRegs(handle, PCA9422_RESET_CTRL, &regVal, 1U);
    if (result == false)
    {
    ...
    /* PWR_SEQ_CTRL */
    regVal = 0x06U;
    result = PCA9422_WriteRegs(handle, PCA9422_PWR_SEQ_CTRL, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_SYS_CFG1, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_SYS_CFG2, &regVal, 1U);
    if (result == false)
    {
    ...
    /* BUCK123_DVS_CFG1 */
    regVal = (uint8_t)((config->buck[0].dvsUpStep << 7U) | (config->buck[0].dvsDnStep << 6U) |
                       (config->buck[1].dvsUpStep << 5U) | (config->buck[1].dvsDnStep << 4U) | (config->smartMode));
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK123_DVS_CFG1, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK123_DVS_CFG2, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK1CTRL, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK2CTRL, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK3CTRL, &regVal, 1U);
    if (result == false)
    {
    ...
    for (i = 0U; i < 8U; i++)
    {
        bxDVS[i] = PCA9422_BUCK1_OUT_VAL(config->buck[0].dvsVout[i]);
    }
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK1OUT_DVS0, bxDVS, 8U);
    if (result == false)
    {
    ...
    for (i = 0U; i < 8U; i++)
    {
        bxDVS[i] = PCA9422_BUCK2_OUT_VAL(config->buck[1].dvsVout[i]);
    }
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK2OUT_DVS0, bxDVS, 8U);
    if (result == false)
    {
    ...
    for (i = 0U; i < 8U; i++)
    {
        bxDVS[i] = PCA9422_BUCK3_OUT_VAL(config->buck[2].dvsVout[i]);
    }
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK3OUT_DVS0, bxDVS, 8U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_REG_LOCK, &regVal, 1U);
    if (result == false)
    {
    ...
    /* BUCK1OUT_STBY */
    regVal = PCA9422_BUCK1_OUT_VAL(config->buck[0].stbyVout);
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK1OUT_STBY, &regVal, 1U);
    if (result == false)
    {
    ...
    regVal = PCA9422_BUCK1_OUT_VAL(config->buck[0].maxVout);
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK1OUT_MAX_LIMIT, &regVal, 1U);
    if (result == false)
    {
    ...
    /* BUCK1OUT_SLEEP */
    regVal = PCA9422_BUCK1_OUT_VAL(config->buck[0].sleepVout);
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK1OUT_SLEEP, &regVal, 1U);
    if (result == false)
    {
    ...
    /* BUCK2OUT_STBY */
    regVal = PCA9422_BUCK2_OUT_VAL(config->buck[1].stbyVout);
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK2OUT_STBY, &regVal, 1U);
    if (result == false)
    {
    ...
    /* BUCK2OUT_MAX_LIMIT */
    regVal = PCA9422_BUCK2_OUT_VAL(config->buck[1].maxVout);
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK2OUT_MAX_LIMIT, &regVal, 1U);
    if (result == false)
    {
    ...
    /* BUCK2OUT_SLEEP */
    regVal = PCA9422_BUCK2_OUT_VAL(config->buck[1].sleepVout);
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK2OUT_SLEEP, &regVal, 1U);
    if (result == false)
    {
    ...
    /* BUCK3OUT_STBY */
    regVal = PCA9422_BUCK3_OUT_VAL(config->buck[2].stbyVout);
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK3OUT_STBY, &regVal, 1U);
    if (result == false)
    {
    ...
    /* BUCK3OUT_MAX_LIMIT */
    regVal = PCA9422_BUCK3_OUT_VAL(config->buck[2].maxVout);
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK3OUT_MAX_LIMIT, &regVal, 1U);
    if (result == false)
    {
    ...
    /* BUCK3OUT_SLEEP */
    regVal = PCA9422_BUCK3_OUT_VAL(config->buck[2].sleepVout);
    result = PCA9422_WriteRegs(handle, PCA9422_BUCK3OUT_SLEEP, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_LDO2_CFG, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO2_OUT */
    regVal = (uint8_t)((config->ldo[0].activeDischg << 7U) | PCA9422_LDO23_OUT_VAL(config->ldo[0].vout));
    result = PCA9422_WriteRegs(handle, PCA9422_LDO2_OUT, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO2_OUT_STBY */
    regVal = PCA9422_LDO23_OUT_VAL(config->ldo[0].stbyVout);
    result = PCA9422_WriteRegs(handle, PCA9422_LDO2_OUT_STBY, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO2_OUT_SLEEP */
    regVal = PCA9422_LDO23_OUT_VAL(config->ldo[0].sleepVout);
    result = PCA9422_WriteRegs(handle, PCA9422_LDO2_OUT_SLEEP, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_LDO3_CFG, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO3_OUT */
    regVal = (uint8_t)((config->ldo[1].activeDischg << 7U) | PCA9422_LDO23_OUT_VAL(config->ldo[1].vout));
    result = PCA9422_WriteRegs(handle, PCA9422_LDO3_OUT, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO3_OUT_STBY */
    regVal = PCA9422_LDO23_OUT_VAL(config->ldo[1].stbyVout);
    result = PCA9422_WriteRegs(handle, PCA9422_LDO3_OUT_STBY, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO3_OUT_SLEEP */
    regVal = PCA9422_LDO23_OUT_VAL(config->ldo[1].sleepVout);
    result = PCA9422_WriteRegs(handle, PCA9422_LDO3_OUT_SLEEP, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO23_CFG */
    regVal = (uint8_t)((config->ldo[0].ldoMode << 6U) | (config->ldo[1].ldoMode << 7U));
    result = PCA9422_WriteRegs(handle, PCA9422_LDO23_CFG, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO4_CFG */
    regVal = (uint8_t)((config->ldo[2].activeDischg << 4U) | (config->ldo[2].enMode));
    result = PCA9422_WriteRegs(handle, PCA9422_LDO4_CFG, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO4_OUT */
    regVal = PCA9422_LDO4_OUT_VAL(config->ldo[2].vout);
    result = PCA9422_WriteRegs(handle, PCA9422_LDO4_OUT, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO4_OUT_STBY */
    regVal = PCA9422_LDO4_OUT_VAL(config->ldo[2].stbyVout);
    result = PCA9422_WriteRegs(handle, PCA9422_LDO4_OUT_STBY, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO4_OUT_SLEEP */
    regVal = PCA9422_LDO4_OUT_VAL(config->ldo[2].sleepVout);
    result = PCA9422_WriteRegs(handle, PCA9422_LDO4_OUT_SLEEP, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO1_CFG1 */
    regVal = (uint8_t)((config->ldo1.activeDischg << 7U) | PCA9422_LDO1_OUT_VAL(config->ldo1.vout));
    result = PCA9422_WriteRegs(handle, PCA9422_LDO1_CFG1, &regVal, 1U);
    if (result == false)
    {
    ...
    /* LDO1_CFG2 */
    regVal = config->ldo1.enMode;
    result = PCA9422_WriteRegs(handle, PCA9422_LDO1_CFG2, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_SW4_BB_CFG1, &regVal, 1U);
    if (result == false)
    {
    ...
    result = PCA9422_WriteRegs(handle, PCA9422_SW4_BB_CFG2, &regVal, 1U);
    if (result == false)
    {
    ...
    /* SW4_BB_CFG3 - BB_VOUT */
    regVal = PCA9422_BB_OUT_VAL(config->buckBoost.vout);
    result = PCA9422_WriteRegs(handle, PCA9422_SW4_BB_CFG3, &regVal, 1U);
    if (result == false)
    {
    ...
    regVal = PCA9422_BB_OUT_VAL(config->buckBoost.stdyVout);
    result = PCA9422_WriteRegs(handle, PCA9422_SW4_BB_CFG4, &regVal, 1U);
    if (result == false)
    {
    ...
    /* SW4_BB_MAX_LIMIT */
    regVal = PCA9422_BB_OUT_VAL(config->buckBoost.maxVout);
    result = PCA9422_WriteRegs(handle, PCA9422_SW4_BB_MAX_LIMIT, &regVal, 1U);
    if (result == false)
    {
    ...
    /* SW4_BB_MIN_LIMIT */
    regVal = PCA9422_BB_OUT_VAL(config->buckBoost.minVout);
    result = PCA9422_WriteRegs(handle, PCA9422_SW4_BB_MIN_LIMIT, &regVal, 1U);
    if (result == false)
    {
    ...
    /* SW4_BB_VOUT_SLEEP */
    regVal = PCA9422_BB_OUT_VAL(config->buckBoost.sleepVout);
    result = PCA9422_WriteRegs(handle, PCA9422_SW4_BB_VOUT_SLEEP, &regVal, 1U);
    if (result == false)
    {
...
void PCA9422_GetDefaultPowerModeConfig(pca9422_modecfg_t *config)
{
    ...
    config->sw2OutVolt = 3300000U;//1100000U;
    /* SW3 output set to 1.0V. */
    config->sw3OutVolt = 1800000U;//1000000U;
    /* SW4 output set to 1.8V. */
    config->sw4OutVolt = 5000000U;//1800000U;
#endif
...
void PCA9422_GetLDO1EnMode(pca9422_handle_t *handle, bool *enmode)
{
    ...
    {
        *enmode = (regVal & PCA9422_LDO1_CFG2_L1_ENMODE) ? true : false;
    }
}
...
void PCA9422_GetRegulatorEnMode(pca9422_handle_t *handle, pca9422_regulator_t reg, pca9422_enmode_t *enmode)
{
    ...
    switch (reg)
    {
        case kPCA9422_RegulatorSwitch1:
            ...
            if (result == false)
                goto out;
            *enmode = (pca9422_enmode_t)(regVal & PCA9422_BUCKXCTRL_BX_ENMODE);
            break;
        ...
        case kPCA9422_RegulatorSwitch4:
            ...
            *enmode = (pca9422_enmode_t)((regVal & PCA9422_SW4_BB_CFG2_BB_ENMODE) >> 2U);
            break;
        ...
        case kPCA9422_RegulatorLdo2:
            ...
            *enmode = (pca9422_enmode_t)(regVal & PCA9422_LDO2_CFG_L2_ENMODE);
            break;
        case kPCA9422_RegulatorLdo3:
            ...
            *enmode = (pca9422_enmode_t)(regVal & PCA9422_LDO3_CFG_L3_ENMODE);
            break;
        case kPCA9422_RegulatorLdo4:
            ...
            *enmode = (pca9422_enmode_t)(regVal & PCA9422_LDO4_CFG_L4_ENMODE);
            break;
        default:
...
void PCA9422_GetRegulatorLPMode(pca9422_handle_t *handle, pca9422_regulator_t reg, pca9422_reg_lpmode_t *lpmode)
{
    ...
    switch (reg)
    {
        case kPCA9422_RegulatorSwitch1:
            ...
            *lpmode = (pca9422_reg_lpmode_t)((regVal & PCA9422_BUCKXCTRL_BX_LPMODE) >> 4U);
            break;
        case kPCA9422_RegulatorSwitch2:
            /* Read BUCK2CTRL */
            regAddr = PCA9422_BUCK2CTRL;
        ...
        case kPCA9422_RegulatorSwitch4:
            ...
            *lpmode = (pca9422_reg_lpmode_t)(regVal & PCA9422_SW4_BB_CFG2_BB_LPMODE);
            break;
        case kPCA9422_RegulatorLdo1:
        ...
        case kPCA9422_RegulatorLdo2:
            ...
            *lpmode = (pca9422_reg_lpmode_t)(regVal & PCA9422_LDO2_CFG_L2_LPMODE);
            if (*lpmode == (uint8_t)kPCA9422_LDO23LPmodeAtRunState)
            {
                *lpmode = (pca9422_reg_lpmode_t)kPCA9422_LPmodeForcedLPM;
            }
            else if (*lpmode == (uint8_t)kPCA9422_LDO23LPmodeAtStandbyDPStandby)
            {
                *lpmode = (pca9422_reg_lpmode_t)kPCA9422_LPmodeAtStandbyDPStandby;
            }
            else if (*lpmode == (uint8_t)kPCA9422_LDO23LPmodeAtDPStandby)
            {
        ...
        case kPCA9422_RegulatorLdo3:
            ...
            *lpmode = (pca9422_reg_lpmode_t)(regVal & PCA9422_LDO3_CFG_L3_LPMODE);
            if (*lpmode == (uint8_t)kPCA9422_LDO23LPmodeAtRunState)
            {
                *lpmode = (pca9422_reg_lpmode_t)kPCA9422_LPmodeForcedLPM;
            }
...
void PCA9422_SetRegulatorVoltage(pca9422_handle_t *handle, pca9422_regulator_t reg, pca9422_vout_t vout, uint32_t volt)
{
    ...
    {
        case kPCA9422_RegulatorSwitch1:
            regVal  = PCA9422_BUCK1_OUT_VAL(volt);
        ...
        case kPCA9422_RegulatorSwitch2:
            regVal  = PCA9422_BUCK2_OUT_VAL(volt);
            regMask = PCA9422_BUCKXOUT_DVS0_BX_DVS0;
            /* Check VOUT type */
            switch (vout)
            {
        ...
        case kPCA9422_RegulatorSwitch3:
            regVal  = PCA9422_BUCK3_OUT_VAL(volt);
            regMask = PCA9422_BUCKXOUT_DVS0_BX_DVS0;
            /* Check VOUT type */
            switch (vout)
            {
            ...
            break;
        case kPCA9422_RegulatorSwitch4:
            regVal  = PCA9422_BB_OUT_VAL(volt);
            regMask = PCA9422_SW4_BB_CFG3_BB_VOUT;
            /* Check VOUT type */
            switch (vout)
            {
        ...
        case kPCA9422_RegulatorLdo1:
            regVal  = PCA9422_LDO1_OUT_VAL(volt);
        ...
        case kPCA9422_RegulatorLdo2:
            regVal  = PCA9422_LDO23_OUT_VAL(volt);
        ...
        case kPCA9422_RegulatorLdo3:
            ...
            break;
        case kPCA9422_RegulatorLdo4:
            regVal  = PCA9422_LDO4_OUT_VAL(volt);
        ...
        case kPCA9422_RegulatorSwitch4:
            ...
            if (regAddr != 0xFFU)
            {
                ...
                if (result == false)
                    goto out;
                regVal = regVal & regMask;
                *volt  = PCA9422_BB_OUT_VOLT(regVal);
            }
            else
            {
                *volt = 0U;
        ...
        case kPCA9422_RegulatorLdo1:
            ...
            if (regAddr != 0xFFU)
            {
                ...
                if (result == false)
                    goto out;
                regVal = regVal & regMask;
                *volt  = PCA9422_LDO1_OUT_VOLT(regVal);
            }
            else
            {
                *volt = 0U;
        ...
        case kPCA9422_RegulatorLdo2:
            ...
            if (regAddr != 0xFFU)
            {
                ...
                if (result == false)
                    goto out;
                regVal = regVal & regMask;
                *volt  = PCA9422_LDO23_OUT_VOLT(regVal);
            }
            else
            {
                *volt = 0U;
...
void PCA9422_SwitchPowerMode(pca9422_handle_t *handle, pca9422_power_mode_t mode)
{
    ...
    if (regVal & PCA9422_SYS_CFG1_STANDBY_CTRL)
    {
        ...
        if (mode == kPCA9422_StandbyMode)
        {
            ...
            PCA9422_ModifyReg(handle, PCA9422_SYS_CFG1, PCA9422_SYS_CFG1_STANDBY_CFG, regVal);
        }
...
bool PCA9422_EnableState(pca9422_power_mode_t powerMode, pca9422_enmode_t enmode)
{
    bool enable;
...
void PCA9422_SetWatchDogTimer(pca9422_handle_t *handle, pca9422_wd_timer_t wd_timer)
{
    ...
    result = PCA9422_ModifyReg(handle, PCA9422_TOP_CNTL0, PCA9422_TOP_CNTL0_WD_TIMER, wd_timer);
    if (result == false)
    {
...
void PCA9422_DisableChargerInterrupts(pca9422_handle_t *handle, uint8_t *source)
{
    ...
    memcpy(source, maskVal, sizeof(maskVal));
