...
static uint8_t sw_version[40] = "R02.QAR88n.01.01.251230.Standalone";
#endif
#if UsingQAR87BoardHwVersion == 1 // Actual Board
#if CES_DEMO_FOR_NOVATEK
static uint8_t sw_version[40] = "R02.QAR88n.02.01.251230.ForNovatek";
#else
static uint8_t sw_version[40] = "R02.QAR88n.02.01.251230.Standalone";
#endif
#endif

#else
#if UsingQAR87BoardHwVersion == 0 // Dev Board
static uint8_t sw_version[60] = "T03.QAR88n.01.01.251223.Standalone.2512310945";
#endif
#if UsingQAR87BoardHwVersion == 1 // Actual Board
static uint8_t sw_version[60] = "T03.QAR88n.02.01.251223.Standalone.2512310945";
#endif
