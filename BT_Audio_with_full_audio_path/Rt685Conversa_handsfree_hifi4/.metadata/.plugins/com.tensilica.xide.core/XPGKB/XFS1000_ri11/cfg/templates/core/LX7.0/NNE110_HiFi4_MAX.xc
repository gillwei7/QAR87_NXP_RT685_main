...
<system_file>
    <xtensa_configuration>
        <config_name buildTS="0" isaSavTS="1648523987391" parent_bid="0" parent_tdb_cksm="0" tieSavTS="0" variant="0">NNE110_HiFi4_MAX</config_name>
        <config_isa description="">
            <core formatversion="7000" isaversion="LX7.0" locked="0" name="NNE110_HiFi4_MAX">
                <coreisa>
                    ...
                    <dataCache cache_test_ops="1" dc.coherent="0" dc.lineSize="256" dc.locking="1" dc.memErr="0" dc.nbanks="4" dc.size="0x00020000" dc.ways="4" dc.writeBack="1" dynamic_way_disable="1"/>
