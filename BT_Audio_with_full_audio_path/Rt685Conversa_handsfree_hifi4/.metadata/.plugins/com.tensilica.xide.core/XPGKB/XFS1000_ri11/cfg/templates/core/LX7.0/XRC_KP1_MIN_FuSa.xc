        ...
        <config_isa description="">
            <core formatversion="7000" isaversion="LX7.0" locked="0" name="XRC_KP1_MIN_FuSa">
                <coreisa>
                    ...
                    <implementation L0IBuffer="256" implBlock="flop" implCgFunctionalUnit="1" implCgGlobal="1" implResetFlops="1" implasyncreset="0" mem.data.gating="0" pso.core.ret="None" pso.domains="None" sem.data.gating="None" teaf="0"/>
                    ...
                    <memerror address_err="1" dataMemErrorType="2" dataMemErrorWidth="4" dramRetry="0" instMemErrorType="2" prefetch_memerror="0"/>
                    <lmem>
                        <lmem.0 busy="1" dma="1" memErr="1" paddr="0x40000000" secsize="0x0" size="0x20000" type="instram.0"/>
                        <lmem.1 busy="1" dma="1" memErr="1" nbanks="2" paddr="0x3ffc0000" secsize="0x0" size="0x20000" type="dataram.0"/>
                        <lmem.2 busy="1" dma="1" memErr="1" nbanks="2" paddr="0x3ffe0000" secsize="0x0" size="0x20000" type="dataram.1"/>
                    </lmem>
                    <smem>
                    ...
                    <pif busBridge="AXI4" dmaDepth="2" pifAsync="0" pifEnabled="1" pifWidthBits="128" pifWriteResp="1" pifver_32="0" prefetchEntries="0" wbBypassAddrBits="0" wbEntries="2"/>
                    ...
                    <pif7 activityPort="0" axi_acelite="0" axi_ecc="none" axi_sec_interface="0" ir_drop_port="0" master_exclaccess="1" num_extn_exclmaster="1" slave_exclaccess="1" udma="0" udma_bufferwidth="4" udma_data_width="0" udma_outstanding_rows="4" udma_reorder_buffer="0"/>
                    ...
                    <vector vecBase1FromPins="0" vectorsReloc="1" vectorsStaticAltBase="0x40000400">
                        ...
                        <vecMemErr prefix="0x30" size="0x180" vaddr="0x50000310"/>
                ...
                <targets>
                    ...
                    <cfg cfg_auto_mmap="0" cfg_auto_vectors="0" cfg_last_written_ver="918" cfg_mmu_lmems_space="0xFE000000" cfg_vector_style="lx2_rel" editor_rel="none" fusa_iso26262="1" template_op="fpmlx_128`1"/>
                </targets>
