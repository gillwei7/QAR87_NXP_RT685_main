...
<system_file>
    <xtensa_configuration>
        <config_name buildTS="0" isaSavTS="1655116355556" parent_bid="0" parent_tdb_cksm="0" tieSavTS="0" variant="0">hifi5_ao_7</config_name>
        <config_isa description="">
            <core formatversion="7000" isaversion="LX7.0" locked="0" name="hifi5_ao_7">
                <coreisa>
                    ...
                    <pif7 activityPort="0" axi_acelite="0" axi_ecc="none" axi_sec_interface="0" ir_drop_port="0" master_exclaccess="1" num_extn_exclmaster="1" slave_exclaccess="1" udma="1" udma_bufferwidth="4" udma_data_width="128" udma_outstanding_rows="4" udma_reorder_buffer="0"/>
