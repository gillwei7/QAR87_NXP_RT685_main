...
<system_file>
    <xtensa_configuration>
        <config_name buildTS="0" isaSavTS="1658832342029" parent_bid="0" parent_tdb_cksm="0" tieSavTS="0" variant="0">XRC_NX_CTL_Cache</config_name>
        <config_isa description="">
            <core formatversion="8000" isaversion="NX1.0" locked="0" name="XRC_NX_CTL_Cache">
                <coreisa>
                    ...
                    <isa arCount="16" brs="1" depbits="1" div32Int="1" etie_enable="0" fp="0" instWidthBytes="4" l32r="l32r" loops="1" maxCoprocs="7" mul32choice="fullupper" prid="0" threadptr="0" tieware="0"/>
                    <fetch L0IBuffer="0" btb_entries="32" btb_rasentries="8" btb_ways="4" inst_missbuffers="3"/>
                    <systemif sys_mif_combine="0" sys_mif_cwf="0" sys_mif_data_apb="0" sys_mif_data_apb_addr="0" sys_mif_data_apb_size="0x00010000" sys_mif_data_width="32" sys_mif_inst_width="32" sys_sif_combine="0" sys_sif_data_idwidth="4" sys_sif_data_width="32" sys_sif_inst_idwidth="4" sys_sif_inst_width="32"/>
                    ...
                    <sdcache sdc_accesswidth="32" sdc_linesize="32" sdc_size="32768" sdc_ways="2"/>
                    <vdcache vdc_accesswidth="256" vdc_size="0"/>
                    <localmems data_latency="2" data_width="32" dram_addr="0x30000000" dram_banks="4" dram_count="1" dram_size="32768" inst_width="32" iram_addr="0x40000000" iram_count="1" iram_size="32768" loadStoreUnits="1"/>
