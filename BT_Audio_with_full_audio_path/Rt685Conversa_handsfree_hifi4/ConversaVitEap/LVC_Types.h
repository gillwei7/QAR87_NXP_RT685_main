...
/*                                                                      */
/*  NXP Confidential and Proprietary. This software is owned or         */
/*  controlled by NXP and may only be used strictly in accordance with  */
/*  the applicable license terms. By expressly accepting such terms or  */
/*  by downloading, installing, activating and/or otherwise             */
/*  using the software, you are agreeing that you have read, and that   */
/*  you agree to comply with and are bound by, such license terms.      */
/*  If you do not agree to be bound by the applicable license terms,    */
/*  then you may not retain, install, activate or otherwise             */
/*  use the software.                                                   */
/*                                                                      */
...
#if CUSTOM_MAPPING
#define CUSTOM_MAPPING_SLOW_MEM  		__attribute__((__section__(".to_slow_mem"))) // function in SLOW sections can be moved to slow memory. This doesn't impact performances
#define CUSTOM_MAPPING_SLOW_1_MEM 		__attribute__((__section__(".to_slow1_mem"))) // function in SLOW_1 sections can be moved to slow memory. This  has a slight impact on performances
#else
#define CUSTOM_MAPPING_SLOW_MEM
#define CUSTOM_MAPPING_SLOW_1_MEM
#endif
...
#if defined(CORE_HIFI3) || defined(CORE_FUSIONF1) || defined(CORE_HIFI4) || defined(CORE_M33)
typedef     LVM_INT32             LVM_UINT_PTR;       ///< to avoid pointer computation issue when 64bits platform (ex: windows)). It permits to get correct pointer address value for manipulation even if 64 bit address.
#else
typedef     uintptr_t             LVM_UINT_PTR;       ///< to avoid pointer computation issue when 64bits platform (ex: windows)). It permits to get correct pointer address value for manipulation even if 64 bit address.
#endif
/****************************************************************************************/
/*                                                                                      */
