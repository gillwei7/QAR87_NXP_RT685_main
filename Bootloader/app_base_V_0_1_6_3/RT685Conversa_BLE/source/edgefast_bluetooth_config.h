...
#define CONFIG_BT_LIM_ADV_TIMEOUT 300
...
#define CONFIG_DEBUG_AVRCP				0
#define AVRCP_TG_CT						1
#define CONFIG_A2DP_CODEC_EXTERNAL      1		//set to 1 to let DSP side do the decoding

//#define HFP_BRIDGING  0
#define CONFIG_BT_HOST_USB_ENABLE         0
...
#define CONFIG_BT_A2DP_MAX_ENDPOINT_COUNT 3
