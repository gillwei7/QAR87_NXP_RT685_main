...
<system_file>
    <xtensa_configuration>
        <config_name buildTS="0" isaSavTS="1667375032248" parent_bid="0" parent_tdb_cksm="0" tieSavTS="0" variant="0">NNE110_HiFi3Z_MAX</config_name>
        <config_isa description="">
            <core formatversion="7000" isaversion="LX7.0" locked="0" name="NNE110_HiFi3Z_MAX">
                <coreisa>
                    ...
                    <dataCache cache_test_ops="1" dc.coherent="0" dc.lineSize="256" dc.locking="1" dc.memErr="0" dc.nbanks="4" dc.size="0x00010000" dc.ways="4" dc.writeBack="1" dynamic_way_disable="1"/>
                    <instCache ic.lineSize="256" ic.locking="1" ic.memErr="0" ic.size="0x00010000" ic.ways="4" ic.widthBits="128"/>
                    ...
                    <lmem>
                        ...
                        <lmem.1 busy="0" dma="1" memErr="0" nbanks="4" paddr="0x5ff00000" secsize="0x0" size="0x20000" type="dataram.0"/>
                        <lmem.2 busy="0" dma="1" memErr="0" nbanks="4" paddr="0x5ff20000" secsize="0x0" size="0x20000" type="dataram.1"/>
                    </lmem>
                    <smem>
                ...
                <build ConfigID0="0xC0039286" ConfigID1="0x2A4A1116" ConfigKey0="0x1E238A2C" ConfigKey1="0xF46A09BC" build_req_id="659734" release="RI-2022.9">
                    <software sw_c_lib="0" sw_earliesthw="LX7.1.9" sw_fusa="0" sw_platforms="linux,win32" sw_redist="1" sw_targets="" sw_version="14.09"/>
                    <syssim syssim_targets=""/>
                    <hardware hw_emulation="no" hw_fusa="0" hw_platforms="linux" hw_rtl="Emulation" hw_version="LX7.1.9"/>
                    <messages>
                        <msg.1 msg.1.origin="Xplorer" msg.1.sev="3" msg.1.txt="&amp;lt;NNE110&amp;gt; + &amp;lt;HiFi3z audioengine&amp;gt; is currently not supported."/>
                    </messages>
                </build>
            </core>
        </config_isa>
