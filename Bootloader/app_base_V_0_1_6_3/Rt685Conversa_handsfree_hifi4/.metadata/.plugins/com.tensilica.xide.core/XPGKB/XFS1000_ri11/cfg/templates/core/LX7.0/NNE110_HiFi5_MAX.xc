...
<system_file>
    <xtensa_configuration>
        <config_name buildTS="0" isaSavTS="1638285695895" parent_bid="0" parent_tdb_cksm="0" tieSavTS="0" variant="0">NNE110_HiFi5_MAX</config_name>
        <config_isa description="">
            <core formatversion="7000" isaversion="LX7.0" locked="0" name="NNE110_HiFi5_MAX">
                <coreisa>
                    ...
                    <isa7d bbnlx_128="0" bbnlx_256="0" bbnlx_32b_isa="0" bbnlx_dp_addsub="0" bbnlx_dp_vfp="0" bbnlx_dualpeaksearch="0" bbnlx_fastreciprsqrt="0" bbnlx_fftsymfir="0" bbnlx_hp_vfp="0" bbnlx_ldpc="0" bbnlx_lfsr="0" bbnlx_sp_addsub="0" bbnlx_sp_reciprsqrtqli="0" bbnlx_sp_vfp="0" bbnlx_turbo="0" bbnlx_vec_regs="32" bbnlx_vectordivide="0" bbnlx_viterbi="0" hifi5_sigtanh="1" ivp26_wideloops="0" pdx4b_wideloops="0" visionp1_fourbit_mac="0"/>
                    ...
                    <dataCache cache_test_ops="1" dc.coherent="0" dc.lineSize="256" dc.locking="1" dc.memErr="0" dc.nbanks="2" dc.size="0x00020000" dc.ways="4" dc.writeBack="1" dynamic_way_disable="1"/>
                    <instCache ic.lineSize="256" ic.locking="1" ic.memErr="0" ic.size="0x00020000" ic.ways="4" ic.widthBits="128"/>
                    <memerror address_err="0" dataMemErrorType="0" dataMemErrorWidth="1" dramRetry="0" instMemErrorType="0" prefetch_memerror="0"/>
                    <lmem>
                        <lmem.0 busy="0" dma="1" memErr="0" paddr="0x5ff80000" secsize="0x0" size="0x80000" type="instram.0"/>
                        <lmem.1 busy="0" dma="1" memErr="0" nbanks="4" paddr="0x5ff00000" secsize="0x0" size="0x40000" type="dataram.0"/>
                        <lmem.2 busy="0" dma="1" memErr="0" nbanks="4" paddr="0x5ff40000" secsize="0x0" size="0x40000" type="dataram.1"/>
                    </lmem>
                    <smem>
                ...
                <targets>
                    ...
                    <cfg cfg_auto_mmap="0" cfg_auto_vectors="0" cfg_last_written_ver="918" cfg_mmu_lmems_space="0xFE000000" cfg_vector_style="lx2_rel" editor_rel="none" fusa_iso26262="0" template_op=""/>
                </targets>
                <build ConfigID0="0" ConfigID1="0" ConfigKey0="0" ConfigKey1="0" build_req_id="" release="">
                    ...
                    <messages>
                        <msg.1 msg.1.origin="Xplorer" msg.1.sev="2" msg.1.txt="Local Memory &amp;lt;Instruction RAM 0&amp;gt; is configured as &amp;lt;512K&amp;gt;. Beyond &amp;lt;128K&amp;gt; is supported, but may cause significant speed (MHz) degradation. Also note that estimation data is not available."/>
                        <msg.2 msg.2.origin="Xplorer" msg.2.sev="2" msg.2.txt="Data Cache beyond 64k is supported, but may cause significant speed (MHz) degradation"/>
                        <msg.3 msg.3.origin="Xplorer" msg.3.sev="2" msg.3.txt="Instruction Cache beyond 64k is supported, but may cause significant speed (MHz) degradation"/>
                    </messages>
                </build>
            </core>
        </config_isa>
