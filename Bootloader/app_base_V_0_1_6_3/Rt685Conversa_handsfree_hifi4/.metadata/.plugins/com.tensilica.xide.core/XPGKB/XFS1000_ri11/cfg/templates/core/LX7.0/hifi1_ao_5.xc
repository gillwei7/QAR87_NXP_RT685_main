...
<system_file>
    <xtensa_configuration>
        <config_name buildTS="0" isaSavTS="1655116295126" parent_bid="0" parent_tdb_cksm="0" tieSavTS="0" variant="0">hifi1_ao_5</config_name>
        <config_isa description="">
            <core formatversion="7000" isaversion="LX7.0" locked="0" name="hifi1_ao_5">
                <coreisa>
                    <isa abs="1" addx="1" arCount="16" branchPredictedTaken="0" brs="0" byteOrder="le" call4_12="0" cbox="0" clamps="1" condStoreSync="1" density="1" div32Int="0" fp="0" hifi2="0" hifi2hd="0" instWidthBytes="6" l32r="l32r" loops="1" mac16="0" maxCoprocs="2" minMax="1" miscSpecRegs="0" mul16="0" mul32="0" mul32US="0" mulIter="0" mulUSReadStage="1" mulUSWriteStage="2" mulUser="0" nsa="1" prid="1" sext="1" sync="1" threadptr="0" tieArbitraryByteEnable="1" tieWideStore="1" unalignedLoadAction="exception" unalignedStoreAction="exception" vectra2="0" vfp="0"/>
                    ...
                    <implementation L0IBuffer="128" implBlock="flop" implCgFunctionalUnit="1" implCgGlobal="1" implResetFlops="1" implasyncreset="0" mem.data.gating="0" pso.core.ret="None" pso.domains="None" sem.data.gating="None" teaf="0"/>
                    <dataCache cache_test_ops="1" dc.coherent="0" dc.lineSize="16" dc.locking="0" dc.memErr="0" dc.nbanks="1" dc.size="16384" dc.ways="4" dc.writeBack="1" dynamic_way_disable="0"/>
                    ...
                    <pif busBridge="none" dmaDepth="4" pifAsync="0" pifEnabled="1" pifWidthBits="64" pifWriteResp="1" pifver_32="0" prefetchEntries="16" wbBypassAddrBits="1" wbEntries="16"/>
                ...
                <targets>
                    ...
                    <cfg cfg_auto_mmap="0" cfg_auto_vectors="0" cfg_last_written_ver="919" cfg_mmu_lmems_space="0xFE000000" cfg_vector_style="lx5_iram" editor_rel="none" fusa_compliance_type="20" fusa_iso26262="0" template_op="hifi_le`1"/>
                </targets>
            </core>
        </config_isa>
