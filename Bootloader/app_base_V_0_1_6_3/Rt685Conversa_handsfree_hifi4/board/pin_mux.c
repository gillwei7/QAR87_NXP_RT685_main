...
{
//all the following config are the same as auto generated code in McuExpresso, only:
//IOPCTL_PIO_INBUF_DI, IOPCTL_PIO_FULLDRIVE_DI are changed to IOPCTL_PIO_INBUF_EN and IOPCTL_PIO_FULLDRIVE_EN
