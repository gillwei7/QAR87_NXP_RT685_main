...
#define AT_NONCACHEABLE_SECTION_ALIGN(var, alignbytes) \
    ...
    //the above line was --- //zzz modified
	//__attribute__((section("NonCacheable"))) var __attribute__((aligned(alignbytes)))  //original
    //__attribute__((section(".dram0.data"))) var __attribute__((aligned(alignbytes)))    //---- zzz
