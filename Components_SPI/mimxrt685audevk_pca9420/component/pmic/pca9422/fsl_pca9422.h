...
#define PCA9422_BUCK1_OUT_STEP       (6250U)    /* 6.25mV */
...
#define PCA9422_BUCK3_OUT_STEP       (6250U)    /* 6.25mV */
 ...
 *
 * @param config Pointer to the PCA9422 configuration structure for regulator.
 */
void PCA9422_GetRegulatorDefaultConfig(pca9422_regulator_config_t *config);
