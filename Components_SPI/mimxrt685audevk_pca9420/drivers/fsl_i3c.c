...
#else
    //100k HZ
    masterConfig->baudRate_Hz.i2cBaud          = 100000U;//400000U;
    masterConfig->baudRate_Hz.i3cPushPullBaud  = 12500000U;//12500000U;
    masterConfig->baudRate_Hz.i3cOpenDrainBaud = 400000U;//2500000U;
#endif
}
